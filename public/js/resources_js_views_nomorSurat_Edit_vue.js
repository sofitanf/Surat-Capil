...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup() {
    ...
    var errorNomorSurat = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(null);
    var id = route.params.id;
    store.getNomorSuratId(id);
    var nomorSurat = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      return store.nomorSuratId;
    });

    var edit = function edit(value) {
      store.updateNomorSuratId({
        id: id,
        payload: value
      }).then(function () {
